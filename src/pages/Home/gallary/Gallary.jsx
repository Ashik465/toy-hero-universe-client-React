     ...
     <h2 className="text-4xl text-[#FFC107]  font-bold my-10">Gallery Section</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-8">
       ...
       <div  data-aos="fade-right" className='md:row-span-2 md:col-span-2'>
         <img src={gallery1} alt="" className="w-full h-full object-cover rounded-xl  " /> 
         </div>
       <div data-aos="fade-left">
         <img src={gallery7} alt="" className="w-full h-full object-cover rounded-xl" /> 
         </div>
       <div data-aos="fade-left">
       ...
       <div data-aos="flip-left" className='md:hidden'>
         <img src={gallery5} alt="" className="w-full h-full object-cover rounded-xl" /> 
         </div>
       <div data-aos="flip-right"  className='md:hidden'>
         <img src={gallery6} alt="" className="w-full h-full object-cover rounded-xl" /> 
         </div>
