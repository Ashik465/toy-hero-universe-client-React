...
const handleUpdateToy = (e) => {    
    ...
    return (
        <>
        <h2  className="text-4xl text-[#FFC107] text-center font-bold my-10"> Update Toy {toyName}</h2>
 ...
 <form onSubmit={handleUpdateToy} className="p-5" >
  ...
  <div className="form-control p-5 ">
      ...
      <textarea name="description" defaultValue={description} placeholder="Toy description" className="textarea textarea-bordered textarea-lg w-full " ></textarea>
